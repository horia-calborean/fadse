package jmetal.algorithm.multiobjective.espea;

import java.util.ArrayList;
import java.util.List;
import jmetal.core.algorithm.impl.AbstractGeneticAlgorithm;
import jmetal.algorithm.multiobjective.espea.util.EnergyArchive;
import jmetal.algorithm.multiobjective.espea.util.EnergyArchive.ReplacementStrategy;
import jmetal.algorithm.multiobjective.espea.util.ScalarizationWrapper;
...
public class ESPEA<S extends Solution<?>> extends AbstractGeneticAlgorithm<S, List<S>> {
   ...
   *
   * @see
   * jmetal.algorithm.impl.AbstractGeneticAlgorithm#selection(java.
   * util.List)
   */
  @Override
   ...
   *
   * @see
   * jmetal.algorithm.impl.AbstractGeneticAlgorithm#reproduction(java.
   * util.List)
   */
  @Override
