...
import jmetal.algorithm.multiobjective.espea.ESPEA;
...
import jmetal.core.util.comparator.FitnessComparator;
...
public class EnergyArchive<S extends Solution<?>> extends AbstractBoundedArchive<S> {
   ...
   *
   * @see jmetal.core.util.archive.BoundedArchive#computeDensityEstimator()
   */
  @Override
