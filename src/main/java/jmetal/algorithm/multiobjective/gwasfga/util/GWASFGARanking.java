package jmetal.algorithm.multiobjective.gwasfga.util;
...
import jmetal.core.util.solutionattribute.impl.NumberOfViolatedConstraints;
import jmetal.core.util.solutionattribute.impl.OverallConstraintViolation;
