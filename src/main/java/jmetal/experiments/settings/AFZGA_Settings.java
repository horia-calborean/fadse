...
import jmetal.metaheuristics.afzga.AFZGA;
import jmetal.metaheuristics.nsgaafr.NSGA_AFR;
import jmetal.qualityIndicator.QualityIndicator;
import jmetal.util.JMException;

public class AFZGA_Settings extends Settings {
     ...
     * @throws JMException
     */
    public AFZGA_Settings(Problem problem) throws JMException {
        super(problem);
    } // NSGAII_Settings
