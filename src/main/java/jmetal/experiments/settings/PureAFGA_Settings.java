...
import jmetal.metaheuristics.pureAFGA.PureAFGA;
import jmetal.qualityIndicator.QualityIndicator;
import jmetal.util.JMException;

public class PureAFGA_Settings extends Settings {
     ...
     * @throws JMException
     */
    public PureAFGA_Settings(Problem problem) throws JMException {
        super(problem);
    }
    ...
    public Algorithm configure() throws JMException {
        ...
        algorithm = new PureAFGA(problem_);
