...
public class Solution implements Serializable {
    ...
    /**
     * Stores the fuzzy membership of the solution to the Apparent Front.
     * Uses in NSGA-AFR
     */
    private double afrMembership_;
    ...
    public Solution(Solution solution) {
        ...
        afrMembership_ = solution.getAfrMembership();
    ...
    public void setAfrMembership(double membership) {
        afrMembership_ = membership;
    }

    public double getAfrMembership() {
        return afrMembership_;
    }
