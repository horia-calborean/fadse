...
public class NSGA_AFR_main {
     ...
     *                           jmetal.metaheuristics.nsgaII.NSGA_AFR_main -
     *                           jmetal.metaheuristics.nsgaII.NSGA_AFR_main problemName -
     *                           jmetal.metaheuristics.nsgaII.NSGA_AFR_main problemName paretoFrontFile
     */
    public static void main(String[] args) throws JMException,
        ...
        fileHandler_ = new FileHandler("NSGA_AFR_main.log");
...
//        problems.add(new ZDT6("Real", 100));
        for (int i = 0; i < problems.size(); i++) {
            ...
            algorithm = new NSGA_AFR(problem);
