package jmetal.core.util.pseudorandom.impl;
...
import jmetal.core.util.pseudorandom.impl.AuditableRandomGenerator.Audit;
import jmetal.core.util.pseudorandom.impl.AuditableRandomGenerator.RandomMethod;
