...
import core.network.client.SimulatorOutputParser;
...
public class GAPOutputParser extends SimulatorOutputParser {
    ...
    /** Constructor */
    public GAPOutputParser(Simulator scbSim) {
        super(scbSim);
    ...
    private int getMyReferenceInstructionCount(FadseIndividual individual) {
        String benchmark = individual.getSelectedBenchmark();
