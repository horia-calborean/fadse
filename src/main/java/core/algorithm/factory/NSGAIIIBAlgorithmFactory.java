...
public class NSGAIIIBAlgorithmFactory<S extends Solution<?>> implements AlgorithmFactoryInterface<S, List<S>>{
    ...
    public WrappedEvolutionaryAlgorithm<S, List<S>> create(InputData inputData, Problem<S> problem) {
        ...
        AbstractEvolutionaryAlgorithm<S, List<S>> nsga3b = new NSGAIIIBBuilder<>(
                problem)
        ...
        return new WrappedEvolutionaryAlgorithm<>(nsga3b, cvsPath, inputData);
    }
