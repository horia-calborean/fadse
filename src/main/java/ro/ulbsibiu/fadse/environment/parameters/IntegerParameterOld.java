...
public class IntegerParameterOld implements ParameterOld {
    ...
    public IntegerParameterOld(String name, String type, String description) {
        init(name, type, description, new Int(0,1));
    }

    public IntegerParameterOld(String name, String type, String description, Int parameter) {
