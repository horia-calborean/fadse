...
public class Exp2ParameterOld implements ParameterOld {
    ...
    public Exp2ParameterOld(String name, String type, String description) {
        init(name, type, description, new Int(1, 6));
    }

    public Exp2ParameterOld(String name, String type, String description, Int variable) {
