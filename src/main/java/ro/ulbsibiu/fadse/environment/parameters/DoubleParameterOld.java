 ...
 */
public class DoubleParameterOld implements ParameterOld {
    ...
    public DoubleParameterOld(String name, String type, String description) {
       init(name, type, description, new Real(0, 1));
    }

    public DoubleParameterOld(String name, String type, String description, Real parameter) {
