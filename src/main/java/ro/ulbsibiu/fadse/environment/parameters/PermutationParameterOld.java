...
public class PermutationParameterOld implements ParameterOld {
    ...
    public PermutationParameterOld(String name, String type, String description) {
        init(name, type, description, new Permutation(size));
    }

    public PermutationParameterOld(String name, String type, String description, Permutation parameter) {
