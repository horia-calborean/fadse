 ...
 */
public class VirtualParameter extends Parameter {
     ...
     *
     */
    public VirtualParameter(String name, String description, String expression) {
    ...
    public Object clone() throws CloneNotSupportedException {
        //return super.clone();
        return new VirtualParameter(this.getName(), this.getDescription(), this.expression);
    }
