...
public class StringParameterOld implements ParameterOld {
    ...
    public StringParameterOld(String name, String type, String description) {
        init(new LinkedList<String>(), name, type, description, new Int());
    }

    public StringParameterOld(List<String> values, String name, String type, String description, Int parameter) {
