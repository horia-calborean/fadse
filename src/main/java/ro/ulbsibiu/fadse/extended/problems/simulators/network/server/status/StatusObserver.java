                    ...
                    try {
                        ...
                        try {
                            ...
                            if (command.equalsIgnoreCase("nrActiveSimulations")) {
                                ...
                                String id = command.substring(command.indexOf(":") + 1);
                                Simulation sim = simulationStatus.getSimulation(id);
                                result = new StringBuilder(sim.getNeighbor().getIp().getHostAddress());
                                ...
                                List<S> solutionSet = u.insertObjectivesValuesIntoSolutions(simulationStatus);

                                String header = u.generateCSVHeader(simulationStatus.getEnvironment());
                                result = new StringBuilder(header);
                                result.append(u.generateCSV(solutionSet));
                                ...
                                result.append(u.generateCSV(r.getSubFront(0)));
                            } else {
